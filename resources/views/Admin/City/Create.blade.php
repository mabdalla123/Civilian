                    ...
                    <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
                        <div class='max-w-md mx-auto space-y-6'>
                            ...
                            <form action="{{route('cities.store')}}" method="POST" class="">
                                @csrf
                                <h2 class="text-2xl font-bold ">Add new City</h2>
                                <p class="my-4 opacity-70">Here You can Add New Cities To Select Form </p>
                                <hr class="my-6">
                                <label class="uppercase text-sm font-bold opacity-70">City Name</label>
                                <input type="text" name="city_name" value="{{ old('city_name')}}" class=" shadow-red-500 p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none "
                                @error('city_name')
